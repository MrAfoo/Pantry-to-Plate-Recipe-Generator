...
import RecipeShareClient from "../../components/RecipeShareClient";

// ---------------------------------------------------------------------------
// Dynamic OG metadata — server-side, reads search params from URL
// generateMetadata works perfectly in page.tsx in Next.js 15
// ---------------------------------------------------------------------------
